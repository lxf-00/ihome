...
def upgrade():
    ...
    sa.Column('real_name', sa.String(length=20), nullable=False),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['ih_user_info.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('amonut', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('WAIT_ACCEPT', 'WAIT_PAYMENT', 'PAID', 'WAIT_COMMENT', 'CANCELED', 'REJECTED'), nullable=True),
